...
function findEmployeeById(employeeId) {
   ...
   function findSpecialization(specialization){
    const foundEmployee = employees.find(employees => employees.specialization === specialization);
    if(foundEmployee){
        ...
        document.getElementById("employeesDetails").innerHTML = 'no employee found with that soecialization'
    }
